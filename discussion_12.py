...
def create_employee_table(cur, conn):
    cur.execute("CREAT TABLE IF NOT EXISTS Employees")
    conn.commit()
...
def add_employee(filename, cur, conn):
    ...
    for item in employee_data:
        ...
        cur.execute("ISNERT INTO Employees (employee_id, first_name, last_name, hire_date, job_id, salary) VALUES (?,?,?,?,?,?)" (employee_id, first_name, last_name, hire_date, job_id, salary))
    conn.commit()
